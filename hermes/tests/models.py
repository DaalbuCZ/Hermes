...
class TestResult(models.Model):
    ...
    hexagon_time_r = models.FloatField()
    hexagon_time_l = models.FloatField()

    y_test_score = models.IntegerField()
    y_test_lf_front = models.FloatField()
    y_test_lf_left = models.FloatField()
    y_test_lf_right = models.FloatField()
    y_test_rf_front = models.FloatField()
    y_test_rf_right = models.FloatField()
    y_test_rf_left = models.FloatField()
